defmodule Mix.Tasks.Gen.RshellAstTypes do
  ...
  ⚠️  **WARNING: DO NOT MANUALLY EDIT lib/bash_parser/ast/rshell_types.ex!** ⚠️

  That file is AUTO-GENERATED by this task. Any manual changes will be
  OVERWRITTEN the next time this generator runs.

  To add or modify AST node types:
  1. Update the grammar in rshell-grammar/grammar.js
  2. Run: cd rshell-grammar && tree-sitter generate
  3. Run: mix gen.rshell_ast_types

  The generator reads from rshell-grammar/src/node-types.json which is
  produced by tree-sitter from the grammar definition.
  ...
  defp generate_types_file(categorized, output_path) do
    ...
    defmodule BashParser.AST.RShellTypes do
      ...
      This file is AUTO-GENERATED by: mix gen.rshell_ast_types
